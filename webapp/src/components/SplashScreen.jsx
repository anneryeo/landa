...
export default function SplashScreen({ onFinish }) {
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      onFinish(); // This tells App.jsx to switch screens
    }, 3000);
  ...
  return (
    <div className="splash">
      <div className="splash-logo-wrap">
        ...
        <svg className="splash-wifi" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100px', height: '100px' }}>
          <defs>
